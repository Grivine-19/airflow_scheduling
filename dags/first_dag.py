...
with DAG(
    ...
    catchup=False #whether or not Airflow should catch up for every scheduled interval between start_date and the current date/time
) as dag:
    pass
